...
begin
  ...
  begin
    ...
    begin
      ...
      FImage.Canvas.FillRect(ScaledXOtstup + Round(ZoomIndex / MaxZoom * 3),
        ScaledYOtstup + Round(ZoomIndex / MaxZoom * 3), ScaledXOtstup +
        ScaledRectWidth, ScaledYOtstup + CenterY);
      ...
      FImage.Canvas.Brush.Color := clWhite;
      FImage.Canvas.Rectangle(ScaledXOtstup + Round(ZoomIndex / MaxZoom * 3),
        ScaledRectHeight + ScaledYOtstup + Round(ZoomIndex / MaxZoom * 3),
        ScaledXOtstup + 2 * Radius + Round(ZoomIndex / MaxZoom * 19),
        ScaledRectHeight + ScaledYOtstup + 2 * Radius + Round(ZoomIndex / MaxZoom * 20));
      ...
      //Граница окна
      FImage.Canvas.Arc(ScaledXOtstup + CenterX - BorderRadius,
        ScaledYOtstup + CenterY - BorderRadius,
        ScaledXOtstup + CenterX + BorderRadius, ScaledYOtstup + CenterY + BorderRadius,
        ScaledXOtstup + CenterX + BorderRadius, ScaledYOtstup + CenterY,
        ScaledXOtstup + CenterX - BorderRadius, ScaledYOtstup + CenterY);
      ...
      FImage.Canvas.MoveTo(ScaledXOtstup + ScaledRectWidth -
        Round(ZoomIndex / MaxZoom * 30), ScaledYOtstup + CenterY);
      FImage.Canvas.AngleArc(ScaledXOtstup + CenterX, ScaledYOtstup +
        CenterY, Radius, 0, 180);

      //Нижний импост
      FImage.Canvas.Rectangle(ScaledXOtstup + Round(ZoomIndex / MaxZoom * 3),
        ScaledRectHeight + ScaledYOtstup + Round(ZoomIndex / MaxZoom * 4),
        ScaledXOtstup + 2 * Radius + Round(ZoomIndex / MaxZoom * 33),
    ...
    begin
      ...
      FImage.Canvas.Pen.Color := clWhite;
      FImage.Canvas.Brush.Color := clWhite;
      FImage.Canvas.Rectangle(ScaledXOtstup + Round(ZoomIndex / MaxZoom * 23),
        (ScaledRectWidth div 2) + ScaledYOtstup + Round(ZoomIndex / MaxZoom * 3),
        ScaledXOtstup + 2 * Radius + Round(ZoomIndex / MaxZoom * 14),
        ScaledYOtstup + 2 * Radius + Round(ZoomIndex / MaxZoom * 8));
      ...
      FImage.Canvas.Brush.Color := clWhite;
      FImage.Canvas.MoveTo(ScaledXOtstup + Round(ZoomIndex / MaxZoom * 4),
        ScaledYOtstup + Round(ZoomIndex / MaxZoom * 4) + (ScaledRectWidth div 2));
      FImage.Canvas.LineTo(ScaledXOtstup + Round(ZoomIndex / MaxZoom * 4),
        ScaledRectHeight + ScaledYOtstup);
      FImage.Canvas.LineTo(ScaledRectWidth + ScaledXOtstup,
        ScaledRectHeight + ScaledYOtstup);
      FImage.Canvas.LineTo(ScaledRectWidth + ScaledXOtstup,
        ScaledYOtstup + Round(ZoomIndex / MaxZoom * 4) + (ScaledRectWidth div 2));
      ...
      //Контур
      if (ScaledYOtstup + (ScaledRectWidth div 2) < ScaledRectHeight -
        Round(ZoomIndex / MaxZoom * 20) + ScaledYOtstup) then
      begin
        ...
        FImage.Canvas.LineTo(ScaledXOtstup + Round(ZoomIndex / MaxZoom * 22),
          ScaledRectHeight - Round(ZoomIndex / MaxZoom * 20) + ScaledYOtstup);
        FImage.Canvas.LineTo(ScaledRectWidth - Round(ZoomIndex / MaxZoom * 14) +
          ScaledXOtstup,
          ScaledRectHeight - Round(ZoomIndex / MaxZoom * 20) + ScaledYOtstup);
        FImage.Canvas.LineTo(ScaledRectWidth - Round(ZoomIndex / MaxZoom * 14) +
          ScaledXOtstup,
    ...
    begin
      ...
      FImage.Canvas.Rectangle(ScaledXOtstup + Round(ZoomIndex / MaxZoom * 22),
        // X4 (конец слева)
        ScaledYOtstup + Round(ZoomIndex / MaxZoom * 2) + ScaledRectHeight -
        Round(GetZoomIndex * 120),
        ScaledRectWidth - Round(ZoomIndex / MaxZoom * 14) + ScaledXOtstup,
        ScaledYOtstup + 2 * ScaledRectHeight - Round(ZoomIndex / MaxZoom * 55));
      ...
      FImage.Canvas.LineTo(ScaledXOtstup + Round(ZoomIndex / MaxZoom * 4),
        ScaledRectHeight + ScaledYOtstup);
      FImage.Canvas.LineTo(ScaledRectWidth + ScaledXOtstup +
        Round(ZoomIndex / MaxZoom * 2), ScaledRectHeight + ScaledYOtstup);
      FImage.Canvas.LineTo(ScaledRectWidth + ScaledXOtstup +
        Round(ZoomIndex / MaxZoom * 2), ScaledYOtstup -
        Round(ZoomIndex / MaxZoom * 2) + ScaledRectHeight - Round(GetZoomIndex * 120));
      FImage.Canvas.LineTo(ScaledRectWidth - Round(ZoomIndex / MaxZoom * 14) +
        ScaledXOtstup, ScaledYOtstup + Round(ZoomIndex / MaxZoom * 2) +
        ScaledRectHeight - Round(GetZoomIndex * 120));
      FImage.Canvas.MoveTo(ScaledXOtstup + Round(ZoomIndex / MaxZoom * 4),
        ScaledYOtstup - Round(ZoomIndex / MaxZoom * 2) + ScaledRectHeight -
        Round(GetZoomIndex * 120));
      FImage.Canvas.LineTo(ScaledXOtstup + Round(ZoomIndex / MaxZoom * 22),
      ...
      FImage.Canvas.LineTo(ScaledXOtstup + Round(ZoomIndex / MaxZoom * 22),
        ScaledRectHeight - Round(ZoomIndex / MaxZoom * 14) + ScaledYOtstup);
      FImage.Canvas.LineTo(ScaledRectWidth - Round(ZoomIndex / MaxZoom * 14) +
        ScaledXOtstup, ScaledRectHeight - Round(ZoomIndex / MaxZoom * 14) +
        ScaledYOtstup);
      FImage.Canvas.LineTo(ScaledRectWidth - Round(ZoomIndex / MaxZoom * 14) +
        ScaledXOtstup, ScaledYOtstup + Round(ZoomIndex / MaxZoom * 2) +
        ScaledRectHeight - Round(GetZoomIndex * 120));
      ...
      FImage.Canvas.Arc(
        ...
        ScaledRectWidth - Round(ZoomIndex / MaxZoom * 14) + ScaledXOtstup,
        // X3 (начало теперь сверху справа)
        ScaledYOtstup + Round(ZoomIndex / MaxZoom * 2) + ScaledRectHeight -
        Round(GetZoomIndex * 120), // Y3 (наверху)

        // Новая конечная точка дуги (нижняя сторона)
        ScaledXOtstup + Round(ZoomIndex / MaxZoom * 22),
        // X4 (конец слева)
        ScaledYOtstup + Round(ZoomIndex / MaxZoom * 2) + ScaledRectHeight -
        Round(GetZoomIndex * 120) // Y4 (остается неизменной)
        );
      ...
      FImage.Canvas.Arc(
        ...
        // X3 (начало сверху справа)
        ScaledYOtstup + Round(ZoomIndex / MaxZoom * 2) + ScaledRectHeight -
        Round(GetZoomIndex * 120), // Y3 (начало сверху)

        // Новая конечная точка дуги (нижняя сторона)
        ScaledXOtstup + Round(ZoomIndex / MaxZoom * 4),
        // X4 (конец слева)
        ScaledYOtstup - Round(ZoomIndex / MaxZoom * 2) + ScaledRectHeight -
        Round(GetZoomIndex * 120) // Y4 (конец внизу)
        );
  ...
  begin
    ...
    TrianglePoints[0] := Point(ScaledXOtstup + Round(ZoomIndex / MaxZoom * 4),
      ScaledDownPoint + ScaledYOtstup - Round(ZoomIndex / MaxZoom * 2));
    // Вершина 1
    ...
    k := 0.7;
    SetLength(TrianglePointsMini, 3);
...
begin
  ...
  begin
    ...
    SetLength(TrianglePointsMiddle, 3);
    // Устанавливаем длину массива
    TrianglePointsMiddle[0] :=
      Point(Xc + Round(k * (TrianglePoints[0].X - Xc)), Yc +
      Round(k * (TrianglePoints[0].Y - Yc)));
    // Вершина 1
    TrianglePointsMiddle[1] :=
      Point(Xc + Round(k * (TrianglePoints[1].X - Xc)), Yc +
      Round(k * (TrianglePoints[1].Y - Yc)));
    // Вершина 2
    TrianglePointsMiddle[2] :=
      Point(Xc + Round(k * (TrianglePoints[2].X - Xc)), Yc +
      Round(k * (TrianglePoints[2].Y - Yc)));  // Вершина 3
    ...
    FImage.Canvas.Pen.Width := 1;
    FImage.Canvas.Brush.Color := clWhite;
    FImage.Canvas.Rectangle((TrianglePointsMiddle[1].X +
      TrianglePointsMiddle[2].X) div 2,
    ...
    WidthHandle := (TrianglePointsMiddle[1].X + TrianglePointsMiddle[2].X) div
      2 - (TrianglePointsMini[1].X + TrianglePointsMini[2].X) div 2;

    FImage.Canvas.Rectangle((TrianglePointsMini[1].X + TrianglePointsMini[2].X) div
      2 + WidthHandle div 4,
      (TrianglePointsMiddle[1].Y + TrianglePointsMiddle[2].Y) div 2 +
      Round(ZoomIndex / MaxZoom * 2),
      (TrianglePointsMiddle[1].X + TrianglePointsMiddle[2].X) div 2 - WidthHandle div 4,
      (TrianglePointsMini[1].Y + TrianglePointsMini[2].Y) div 2 +
      Round(ZoomIndex / MaxZoom * 28));
  end;
  ...
  begin
    ...
    FImage.Canvas.Pen.Color := clWhite;
    FImage.Canvas.Brush.Color := clWhite;
    FImage.Canvas.Rectangle(ScaledXOtstup, ScaledRectHeight +
      ScaledYOtstup + Round(ZoomIndex / MaxZoom * 3), ScaledXOtstup +
      2 * Radius + Round(ZoomIndex / MaxZoom * 19), ScaledRectHeight +
      ScaledYOtstup + 2 * Radius + Round(ZoomIndex / MaxZoom * 20));
    ...
    FImage.Canvas.AngleArc(ScaledXOtstup + CenterX, ScaledYOtstup +
      CenterY, Radius, 0, 180);
    FImage.Canvas.MoveTo(ScaledXOtstup + ScaledRectWidth -
      Round(ZoomIndex / MaxZoom * 45), ScaledYOtstup + CenterY);
    FImage.Canvas.AngleArc(ScaledXOtstup + CenterX, ScaledYOtstup + CenterY,
      Radius - Round(ZoomIndex / MaxZoom * 15), 0, 180);
...
begin
  ...
  PolygonVerteces[0] := Point(FXOtstup, FYOtstup);
  // верхний левый угол
  PolygonVerteces[1] := Point(FXOtstup + FRectW, FYOtstup);
  // верхний правый угол
  PolygonVerteces[2] := Point(FXOtstup + FRectW, FYOtstup + FRectH);
  // нижний правый угол
  PolygonVerteces[3] := Point(FXOtstup, FYOtstup + FRectH);
  // нижний левый угол
end;
...
begin
  ...
  FImage.Canvas.Rectangle(Round(CurrPoint.X * GetZoomIndex) -
    Round(ZoomIndex / MaxZoom * 2), Round(CurrPoint.Y * GetZoomIndex) -
    Round(ZoomIndex / MaxZoom * 2),
    Round(CurrPoint.X * GetZoomIndex) + Round(ZoomIndex / MaxZoom * 10),
    Round(CurrPoint.Y * GetZoomIndex) + Round(ZoomIndex / MaxZoom * 10));
end;
