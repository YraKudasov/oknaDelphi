...
begin
  ...
  Image1.Canvas.TextOut(ScaledWidth+35, ScaledHeight div 2 - 10, IntToStr(FRectWidth));
  ...
  Image1.Canvas.TextOut(ScaledWidth div 2 - 10, ScaledHeight + 35, IntToStr(FRectHeight));
