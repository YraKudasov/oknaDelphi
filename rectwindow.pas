...
begin
  ...
  FImage.Canvas.LineTo(ScaledXOtstup + Round(PolygonVerteces[i].X* GetZoomIndex)+Round(ZoomIndex / MaxZoom * 4), ScaledYOtstup + Round(PolygonVerteces[i].Y* GetZoomIndex)+Round(ZoomIndex / MaxZoom * 4))
  else if ((PolygonVerteces[i].X = FXOtstup) and (PolygonVerteces[i].Y <> FYOtstup))then
  FImage.Canvas.LineTo(ScaledXOtstup + Round(PolygonVerteces[i].X* GetZoomIndex)+Round(ZoomIndex / MaxZoom * 4), ScaledYOtstup + Round(PolygonVerteces[i].Y* GetZoomIndex))
  else if ((PolygonVerteces[i].X <> FXOtstup) and (PolygonVerteces[i].Y = FYOtstup))then
  FImage.Canvas.LineTo(ScaledXOtstup + Round(PolygonVerteces[i].X* GetZoomIndex), ScaledYOtstup + Round(PolygonVerteces[i].Y* GetZoomIndex)+Round(ZoomIndex / MaxZoom * 4))
  else
  FImage.Canvas.LineTo(ScaledXOtstup + Round(PolygonVerteces[i].X* GetZoomIndex), ScaledYOtstup + Round(PolygonVerteces[i].Y* GetZoomIndex));

  // Замыкаем многоугольник линией от последней точки к первой
 if((PolygonVerteces[0].X = FXOtstup) and (PolygonVerteces[0].Y = FYOtstup))then
  FImage.Canvas.LineTo(ScaledXOtstup + Round(PolygonVerteces[0].X* GetZoomIndex)+Round(ZoomIndex / MaxZoom * 4), ScaledYOtstup + Round(PolygonVerteces[0].Y* GetZoomIndex)+Round(ZoomIndex / MaxZoom * 4))
  else if ((PolygonVerteces[0].X = FXOtstup) and (PolygonVerteces[0].Y <> FYOtstup))then
  FImage.Canvas.LineTo(ScaledXOtstup + Round(PolygonVerteces[0].X* GetZoomIndex)+Round(ZoomIndex / MaxZoom * 4), ScaledYOtstup + Round(PolygonVerteces[0].Y* GetZoomIndex))
  else if ((PolygonVerteces[0].X <> FXOtstup) and (PolygonVerteces[0].Y = FYOtstup))then
  FImage.Canvas.LineTo(ScaledXOtstup + Round(PolygonVerteces[0].X* GetZoomIndex), ScaledYOtstup + Round(PolygonVerteces[0].Y* GetZoomIndex)+Round(ZoomIndex / MaxZoom * 4))
  else
  FImage.Canvas.LineTo(ScaledXOtstup + Round(PolygonVerteces[0].X* GetZoomIndex), ScaledYOtstup + Round(PolygonVerteces[0].Y* GetZoomIndex));
end;
